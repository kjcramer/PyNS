...
# =============================================================================
def normal_config_salt_2(t_h_in,u_h_in,ndt,restart = False):
# -----------------------------------------------------------------------------
    """
    Args:
    ...
    name = 'N_salt_' + str(t_h_in) + '_' + str(u_h_in).replace("0.", "") + '_' + str(airgap).replace("0.00", "")
    ...
    yn = (nodes(-airgap, 0,12), nodes(0, 0.01, 48), nodes(- airgap - 0.0005, -airgap, 3))
