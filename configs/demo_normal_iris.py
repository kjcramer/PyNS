...
timestep = int(float(sys.argv[4]))*1000
...
#u_h_in = 0.05 # m/s, defined by command line argument
#t_h_in = 80   # C, defined by command line argument
a_salt = 90.0 # g/l
t_c_in = 15   # C

# Time-stepping parameters
dt  =    0.0001    # time step
ndt =    timestep  # number of time steps, defined by command line argument
...
# restart options
#restart = False, defined by command line argument
