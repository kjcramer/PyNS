...
if airgap == '05':
  ...
  reversed_config_salt_05(t_h_in, u_h_in, timesteps, restart)
elif airgap == '2':
  print('=============== running normal_config_2 now ==============' )
  reversed_config_salt_2(t_h_in, u_h_in, timesteps, restart)
elif airgap == '8':
  print('=============== running normal_config_8 now ==============' )
  reversed_config_salt_8(t_h_in, u_h_in, timesteps, restart)
else:
