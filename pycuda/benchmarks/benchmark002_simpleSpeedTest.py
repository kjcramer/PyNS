...
# ------------------------------------------------------------------------------
    ...
    EW_loop = start.time_till(end)*1e-3
    ...
    cputime = start.time_till(end)*1e-3
...
np.savez('outData_benchmark002.npz', size=SZ, iterations=ITERS, times=times)
