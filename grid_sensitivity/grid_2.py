...
t[AIR].val[:,:,:] = np.reshape(np.linspace(30,t_h_in,num=t[AIR].val.shape[1]),[1,t[AIR].val.shape[1],1]) #round((t_h_in+t_c_in)/2,-1) #
t[H2O].val[:,:,:] = 70
t[FIL].val[:,:,:] = 30
t[COL].val[:,:,:] = t_c_in
